...
public class Version_1_21_R4 implements VersionWrapper{
    /**
    ...
    public void openBeaconMenu(Block beacon, Player player) {
        ...
        Container containerHandle = ((TileEntityBeacon) beaconTileHandle).createMenu(playerHandle.nextContainerCounter(), playerHandle.gj(), playerHandle); //gj(): getInventory()
