...
public class Version_1_19_R3 implements VersionWrapper{
    /**
    ...
    public void openBeaconMenu(Block beacon, Player player) {
        ...
        ItemStack itemStackHandle = playerHandle.fJ().f(); //fJ().f(): getInventory().getSelected()
        ...
        World levelHandle = playerHandle.x(); //x(): getWorld()
