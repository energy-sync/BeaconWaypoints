...
public class GUIs {
    ...
    public static void beaconMenu(Player player, Waypoint waypoint) {
        ...
        vanillaBeaconButton.setOnClick(e -> {
            ...
            WaypointCoord waypointCoord = waypoint.getCoord();
            Vec3D blockLocVec3D = new Vec3D(waypointCoord.getX(), waypointCoord.getY(), waypointCoord.getZ());
            ...
            net.minecraft.world.level.block.Block beaconHandle = ((CraftBlock) beacon).getNMS().b();
            ItemStack itemStackHandle = playerHandle.fq().f();
            ...
            IBlockData blockState = beaconHandle.a(blockPlaceContext);
            World levelHandle = playerHandle.W();
            BlockPosition blockPos = new BlockPosition(blockLocVec3D);
            beaconHandle.a(blockState, levelHandle, blockPos, playerHandle, EnumHand.a, blockHitResult);
        });
