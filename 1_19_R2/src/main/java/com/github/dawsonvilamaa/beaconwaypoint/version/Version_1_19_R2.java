...
public class Version_1_19_R2 implements VersionWrapper {
    ...
    public void openBeaconMenu(Block beacon, Player player) {
        ...
        ItemStack itemStackHandle = playerHandle.fE().f(); //fE().f(): getInventory().getSelected()
        ...
        World levelHandle = playerHandle.y(); //y(): getWorld()
